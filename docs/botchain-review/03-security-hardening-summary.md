...
4. Snapshot-based ERC-20, ERC-721, and ERC-1155 eligibility with configurable minimum holdings in the fresh mainnet deployment, followed by credential and membership modules.
